...
epb: we have estimators. they have estimands. what are they? if we want to use our dataset to draw a conclusion,
we need to make some inferences.
---
...
epb: collect a reasonable amount of data and make a reasonable prediction
...
epb: want to make conclusions about #1 or #2, we need to make some inferences
---
...
epb: ethical considerations meant that the results were so overwhelming in one case where they didn't continue with the trial
epb: there was a lot of evidence the treatment was effective but equipoise: can you give a control when you know it works
...
epb: #4 averages over the mechanism, rather than looking at the mechanism
---
...
epb: probability model and sampling model are all you need to make an eestimate/conclusion
epb: #8 and #9 are data-based inferences
...
1. Frequency probability: is the long run proportion of
 ...
 repetitions.
 epb: like flipping a coin, limit of heads will go to 50%
...
epb: using the best tool for the job based on a variety of different factors
