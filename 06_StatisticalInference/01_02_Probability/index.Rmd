...
epb: probability operates on sets
...
epb: if w is 4 and e is the set of {2,4,6} (evens), and f is the set of {2,4,6,8} then:
#1 means that w implies e (4 is an even number)
#2 if w=5, it implies e is false
#3 it's inherent that if e is true, f is also true
#4
---
